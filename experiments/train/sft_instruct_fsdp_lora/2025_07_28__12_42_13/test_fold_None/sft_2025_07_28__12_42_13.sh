#!/bin/bash -l
#SBATCH --output projects/collectively_grounded_llms/experiments/train/sft_instruct_fsdp_lora/2025_07_28__12_42_13/test_fold_None/slurm-%x-%j.out
#SBATCH --error projects/collectively_grounded_llms/experiments/train/sft_instruct_fsdp_lora/2025_07_28__12_42_13/test_fold_None/slurm-%x-%j.out
#SBATCH --chdir ./
#SBATCH --job-name sft_instruct_fsdp_lora_2025_07_28__12_42_13
#
#SBATCH --nodes=5
...
export WANDB_RUN_GROUP="Lama-3-8B-Instruct-lr-1e-4-LoRA | 2025_07_28__12_42_13"
...
export PROGRAM="src/sft.py --config projects/collectively_grounded_llms/experiments/train/sft_instruct_fsdp_lora/2025_07_28__12_42_13/test_fold_None/sft_2025_07_28__12_42_13.yml"
