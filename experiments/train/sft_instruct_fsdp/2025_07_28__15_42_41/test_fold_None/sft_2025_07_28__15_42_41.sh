#!/bin/bash -l
#SBATCH --output projects/collectively_grounded_llms/experiments/train/sft_instruct_fsdp/2025_07_28__15_42_41/test_fold_None/slurm-%x-%j.out
#SBATCH --error projects/collectively_grounded_llms/experiments/train/sft_instruct_fsdp/2025_07_28__15_42_41/test_fold_None/slurm-%x-%j.out
#SBATCH --chdir ./
#SBATCH --job-name sft_instruct_fsdp_2025_07_28__15_42_41
#
#SBATCH --nodes=5
...
export WANDB_RUN_GROUP="Llama-3-8B-Instruct-lr-5e-6-Full | 2025_07_28__15_42_41"
...
export PROGRAM="src/sft.py --config projects/collectively_grounded_llms/experiments/train/sft_instruct_fsdp/2025_07_28__15_42_41/test_fold_None/sft_2025_07_28__15_42_41.yml"
